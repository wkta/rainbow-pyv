...
def is_visible(cell) -> bool:
    ...
    # (ex 2):
    return pyv.actors.trigger('test', glvars.ref_visibility_mger, cell)
...
def new_maze():
    ...
    def terrain_gen(this):
        ...
        if this.exit_entity:
            pyv.actors.del_actor(this.exit_entity)
            this.exit_entity = None
        if this.ref_player:
            pyv.actors.del_actor(this.ref_player)
    ...
    return pyv.actors.new_actor('maze', locals())
