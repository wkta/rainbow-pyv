...
def draw_text(surf, text, size, font, x, y, color, align="normal"):
    font = pygame.font.Font(None, size)  # font, size)
    ...
    if align == "centered":
        ...
        text_rect.x = x
        text_rect.y = y
    surf.blit(text_surface, (text_rect.left, text_rect.top))
...
def draw_text2(surf, text, font, font_size, position, color, align="normal", italic=False):
    ...
    # Create Font object
    font = pygame.font.Font(None, font_size)  # font, font_size)
    ...
    if align == "normal":
        ...
        dest[1] = position[1]
    txt_surf = pygame.transform.rotate(text_surface,90)
    # Display text on surface
    surf.blit(txt_surf, dest)
